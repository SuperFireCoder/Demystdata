      ...
      <table className="min-w-full bg-white border border-gray-200">
        <thead>
          <tr className="w-full bg-gray-100">
            ...
            <th className="text-right py-3 px-4 uppercase font-semibold text-sm">Current Period</th>
            <th className="text-right py-3 px-4 uppercase font-semibold text-sm">Previous Period</th>
          </tr>
        </thead>
        <tbody>
